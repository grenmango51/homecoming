...
class FlightComparisonTests(unittest.TestCase):
    ...
    def test_compare_records_unpaired(self) -> None:
        ...
        comps = cf.compare_records(google, skyscanner)
        c = comps[0]
        self.assertEqual(c["winner"], "Google Flights (Only)")
        self.assertEqual(c["cheapest_price_eur"], 863.0)
        self.assertIsNone(c["savings_eur"])
    ...
    def test_write_comparison_reports(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as td:
            csv_path, json_path = cf.write_comparison_reports(Path(td), comps, stamp="test_stamp")
            ...
            self.assertEqual(data["reference_pair_2026_12_09_2027_01_09"]["winner"], "Skyscanner")
